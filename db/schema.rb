...
ActiveRecord::Schema.define(version: 2023_04_09_194351) do
  ...
  create_table "cages", force: :cascade do |t|
    ...
    t.string "power_status", default: "active"
    t.index ["name"], name: "index_cages_on_name"
  end
  ...
  create_table "dinosaurs", force: :cascade do |t|
    ...
    t.index ["species_id", "diet"], name: "index_dinosaurs_on_species_id_and_diet"
